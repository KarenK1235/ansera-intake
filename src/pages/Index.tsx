...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-[#CFCFCB] py-6 px-3 font-sans text-sm">
      <div className="mx-auto max-w-5xl overflow-hidden rounded-[6px] border border-[#d2ccc0] bg-[#F2F1EC] shadow-2xl">
        {/* Header */}

...
Business Model Other: ${data.businessModelOther || ""}
...
Auto-Detect Language: ${data.autoDetectLanguage === true ? "Yes" : "No"}
...
SOP URL/File/Text: ${data.refSopUrl || data.refSopText || data.refSopFile || ""}
Existing Scripts/Greetings: ${data.refScripts ? "Yes" : "No"}
Scripts URL/File/Text: ${data.refScriptsUrl || data.refScriptsText || data.refScriptsFile || ""}
